# Obsidian Watch - NeoForge 26.2

Standalone NeoForge 26.2 adapter scaffold for Obsidian Watch.
...
.\scripts\build-neoforge-26.2.ps1
```

Expected output:

```txt
NeoForge\platforms\neoforge-26.2\build\libs\obsidian_watch-1.0.0-pre1+neoforge.26.2.jar
```
