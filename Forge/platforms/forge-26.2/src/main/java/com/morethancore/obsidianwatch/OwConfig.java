...
public final class OwConfig {
    ...
    public static final ForgeConfigSpec.IntValue SYNC_INTERVAL_SECONDS;
    public static final ForgeConfigSpec.ConfigValue<String> SERVER_BRAND;
    public static final ForgeConfigSpec.ConfigValue<String> SERVER_NAME_OVERRIDE;
    public static final ForgeConfigSpec.BooleanValue NOTIFY_OPS;
    public static final ForgeConfigSpec.EnumValue<ConfirmedAction> CONFIRMED_ACTION;
    public static final ForgeConfigSpec.EnumValue<WatchlistAction> WATCHLIST_ACTION;
    public static final ForgeConfigSpec.BooleanValue POST_ACTION_LOGS;
    public static final ForgeConfigSpec.BooleanValue ALLOW_REAL_BANS;
    public static final ForgeConfigSpec.IntValue JOIN_ACTION_COOLDOWN_SECONDS;
    public static final ForgeConfigSpec.IntValue TEMPBAN_DURATION_SECONDS;
    public static final ForgeConfigSpec.BooleanValue EXEMPT_OPS;
    public static final ForgeConfigSpec.BooleanValue EXEMPT_CREATIVE;
    public static final ForgeConfigSpec.ConfigValue<String> LOCAL_EXEMPT_UUIDS;
