# Obsidian Watch - Forge 26.1.2

Standalone Forge 26.1.2 adapter scaffold for Obsidian Watch.
...
.\scripts\build-forge-26.1.2.ps1
```

Expected output:

```txt
Forge\platforms\forge-26.1.2\build\libs\obsidian_watch-1.0.0-pre1+forge.26.1.2.jar
```
