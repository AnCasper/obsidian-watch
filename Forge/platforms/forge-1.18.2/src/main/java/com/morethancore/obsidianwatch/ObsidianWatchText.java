...
public final class ObsidianWatchText {
    ...
    public static MutableComponent title(String value) {
        return new TextComponent(value).withStyle(BRAND, ChatFormatting.BOLD);
    }

    public static MutableComponent subtitle(String value) {
        return new TextComponent(value).withStyle(ChatFormatting.AQUA);
    }
    ...
    public static MutableComponent line(String label, String value, ChatFormatting valueColor) {
        return new TextComponent(label + ": ").withStyle(LABEL)
                .append(new TextComponent(value == null || value.isBlank() ? "-" : value).withStyle(valueColor));
    }

    public static MutableComponent command(String command, String description) {
        return new TextComponent(command).withStyle(ChatFormatting.AQUA)
                .append(new TextComponent(" - ").withStyle(MUTED))
                .append(new TextComponent(description).withStyle(LABEL));
    }

    public static MutableComponent section(String value) {
        return new TextComponent(value).withStyle(ChatFormatting.GOLD, ChatFormatting.BOLD);
    }
